...
void King::calc_possible_squares(){
    ...
    pair<int,int> square = {letter_to_number(curr_square.first), the_maggie_function(curr_square.second)};
    ...
    if (!has_moved && !in_check){
        ...
        square = {letter_to_number(curr_square.first), the_maggie_function(curr_square.second)};
        square.first -= 1;
    ...
    if (board[the_maggie_function(square.second) - 1][curr_square.first] == nullptr && !check_for_check(this)){
        cout << "king curr square: " << curr_square.first << curr_square.second << endl;
        possible_squares.push_back(curr_square);
        curr_square = curr_square_holder;
    }
    curr_square.first = number_to_letter(letter_to_number(curr_square.first - 1));
    if (board[the_maggie_function(curr_square.second) - 1][curr_square.first - 2] == nullptr && !check_for_check(this)){
        possible_squares.push_back(curr_square);
        curr_square = curr_square_holder;
    }
    curr_square.second = number_to_letter(curr_square.second + 1);
    if (board[the_maggie_function(curr_square.second) - 1][curr_square.first] == nullptr && !check_for_check(this)){
        possible_squares.push_back(curr_square);
        curr_square = curr_square_holder;
    }
    curr_square.second = number_to_letter(curr_square.second - 1);
    ...
    curr_square.first = number_to_letter(letter_to_number(curr_square.first + 1));
    curr_square.second = number_to_letter(curr_square.second + 1);
    if (board[the_maggie_function(curr_square.second) - 1][curr_square.first - 1] == nullptr && !check_for_check(this)){
        possible_squares.push_back(curr_square);
        curr_square = curr_square_holder;
    }
    curr_square.first = number_to_letter(letter_to_number(curr_square.first + 1));
